...
const GHL_WEBHOOK_URL = "https://services.leadconnectorhq.com/hooks/zemOrVB3bS5ADz7ow32o/webhook-trigger/14da2c77-c89f-40a0-bd0d-8f71beaa449e";
        ...
        {sent ? (
          ...
          <Fade delay={0.1}>
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 }}>
              ...
              <input aria-label="Email address" style={inputStyle} placeholder="Email *" type="email" value={form.email} onChange={e=>setForm({...form,email:e.target.value})}/>
...
function Footer() {
  ...
  const handleSub = async () => {
    ...
    } catch { /* show success regardless; lead still captured client-side intent */ }
    setSubbed(true);
  };
